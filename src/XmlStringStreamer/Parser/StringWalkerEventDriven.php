 ...
 */
class StringWalkerEventDriven implements ParserInterfaceEventDriven
{
    /**
     ...
     */
    protected function prepareChunk($supplied_chunk)
    {
     ...
     */
    public function getNodeFrom($supplied_chunk)
    {
        // Iterate and append to $this->chunk
        if ($this->prepareChunk($supplied_chunk)) {
            $this->firstRun = false;
            // Shave off elements
